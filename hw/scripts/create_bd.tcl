...
proc create_root_design { parentCell } {
  ...
  [get_bd_pins rst_clk_wiz_0/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst  [get_bd_pins mdm_1/Debug_SYS_Rst] \
  [get_bd_pins rst_clk_wiz_0/mb_debug_sys_rst] \
  ...
  [get_bd_pins rst_clk_wiz_0/slowest_sync_clk] \
  ...
  [get_bd_pins rst_clk_wiz_0/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_bus_struct_reset  [get_bd_pins rst_clk_wiz_0/bus_struct_reset] \
  [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net rst_clk_wiz_0_mb_reset  [get_bd_pins rst_clk_wiz_0/mb_reset] \
  [get_bd_pins microblaze_0/Reset] \
  [get_bd_pins microblaze_0_axi_intc/processor_rst]
  connect_bd_net -net rst_clk_wiz_0_peripheral_aresetn  [get_bd_pins rst_clk_wiz_0/peripheral_aresetn] \
  ...
  connect_bd_net -net xlconstant_gnd_dout  [get_bd_pins xlconstant_gnd/dout] \
  [get_bd_pins xadc_wiz_0/vp_in] \
  [get_bd_pins xadc_wiz_0/vn_in]
